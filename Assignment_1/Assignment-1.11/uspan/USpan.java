...
public class USpan {
	...
	* the idea is to always reuse the same buffer to reduce memory usage. **/
	...
	protected final boolean SAVE_RESULT_EASIER_TO_READ_FORMAT = false;
...
//			System.out.println(entry.getKey() + "  swu: " + entry.getValue().swu);
	 ...
	 */
    protected void checkIfUtilityOfPatternIsCorrect(int[] prefix, int prefixLength, int utility) throws IOException {
